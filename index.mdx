...
<div data-product-guide-index className="flex w-full flex-col gap-8 max-w-5xl mx-auto px-4 md:px-8 lg:px-12 py-10 lg:gap-14 lg:py-16">
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
    <Card
      ...
      size={64}
    >
      <span className="product-guide-feature-card-description">Sign up, create your first document, and publish it in minutes.</span>
    </Card>
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        <span className="font-serif text-base font-medium text-gray-900 dark:text-gray-50">Webhooks & integrations</span>
        <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
          Push document events to Zapier, Make, n8n, and any HTTP endpoint.
        </span>
      </div>
    </a>
    <a
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
          Programmatically create, retrieve, and publish documents via the REST API.
        </span>
      </div>
    </a>
  </div>
