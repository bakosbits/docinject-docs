...
```
GET https://api.docinject.com/{org_slug}/inbox/{doc_id}/export?template_id={template_id}
```
...
```bash curl
curl "https://api.docinject.com/{org_slug}/inbox/doc_01hxyz1a2b3c4d5e6f7g8h9j/export?template_id=tmpl_01habcdefghijklmnopqrstu" \
...
const res = await fetch(
  `https://api.docinject.com/{org_slug}/inbox/${docId}/export?template_id=${templateId}`,
  {
...
res = requests.get(
    f'https://api.docinject.com/{org_slug}/inbox/{doc_id}/export',
...
```
GET https://api.docinject.com/{org_slug}/inbox/{doc_id}/export/markdown
```
...
```bash curl
curl "https://api.docinject.com/{org_slug}/inbox/doc_01hxyz1a2b3c4d5e6f7g8h9j/export/markdown" \
  -H "Authorization: Bearer YOUR_API_KEY" \
...
const res = await fetch(
  `https://api.docinject.com/{org_slug}/inbox/${docId}/export/markdown`,
  {
    headers: { Authorization: `Bearer ${process.env.DOCINJECT_API_KEY}` },
  }
);
...
res = requests.get(
    f'https://api.docinject.com/{org_slug}/inbox/{doc_id}/export/markdown',
    headers={'Authorization': f'Bearer {os.environ["DOCINJECT_API_KEY"]}'},
)
