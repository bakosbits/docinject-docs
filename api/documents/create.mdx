...
```
POST https://api.docinject.com/{org_slug}/inbox
```
...
```bash curl
curl -X POST "https://api.docinject.com/{org_slug}/inbox" \
...
```
PATCH https://api.docinject.com/{org_slug}/inbox/{doc_id}
```
...
```bash curl
curl -X PATCH "https://api.docinject.com/{org_slug}/inbox/doc_01hzab1c2d3e4f5g6h7j8k9l" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
...
const res = await fetch(
  'https://api.docinject.com/{org_slug}/inbox/doc_01hzab1c2d3e4f5g6h7j8k9l',
  {
    method: 'PATCH',
    headers: {
      Authorization: `Bearer ${process.env.DOCINJECT_API_KEY}`,
...
```
DELETE https://api.docinject.com/{org_slug}/inbox/{doc_id}
```
...
```bash curl
curl -X DELETE "https://api.docinject.com/{org_slug}/inbox/doc_01hzab1c2d3e4f5g6h7j8k9l" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```
POST https://api.docinject.com/{org_slug}/inbox/{doc_id}/nodes
```
...
```bash curl (section)
curl -X POST "https://api.docinject.com/{org_slug}/inbox/doc_01hzab1c2d3e4f5g6h7j8k9l/nodes" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "node_type": "section",
...
```
PATCH https://api.docinject.com/{org_slug}/inbox/{doc_id}/nodes/{node_id}
```
...
```bash curl
curl -X PATCH "https://api.docinject.com/{org_slug}/inbox/doc_01hzab1c2d3e4f5g6h7j8k9l/nodes/node_01ha1b2c3d4e5f6g" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
...
```
DELETE https://api.docinject.com/{org_slug}/inbox/{doc_id}/nodes/{node_id}
```
...
```bash curl
curl -X DELETE "https://api.docinject.com/{org_slug}/inbox/doc_01hzab1c2d3e4f5g6h7j8k9l/nodes/node_01ha1b2c3d4e5f6g" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```
POST https://api.docinject.com/{org_slug}/inbox/{doc_id}/nodes/reorder
```
...
```bash curl
curl -X POST "https://api.docinject.com/{org_slug}/inbox/doc_01hzab1c2d3e4f5g6h7j8k9l/nodes/reorder" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "nodes": [
