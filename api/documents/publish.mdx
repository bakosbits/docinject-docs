...
```
POST https://api.docinject.com/{org_slug}/inbox/{doc_id}/publish
```
...
```bash curl
curl -X POST "https://api.docinject.com/{org_slug}/inbox/doc_01hzab1c2d3e4f5g6h7j8k9l/publish" \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```javascript JavaScript
const res = await fetch(
  'https://api.docinject.com/{org_slug}/inbox/doc_01hzab1c2d3e4f5g6h7j8k9l/publish',
  {
    method: 'POST',
...
```
POST https://api.docinject.com/{org_slug}/inbox/{doc_id}/revise
```
...
```bash curl
curl -X POST "https://api.docinject.com/{org_slug}/inbox/doc_01hzab1c2d3e4f5g6h7j8k9l/revise" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```
POST https://api.docinject.com/{org_slug}/inbox/{doc_id}/archive
```
...
```bash curl
curl -X POST "https://api.docinject.com/{org_slug}/inbox/doc_01hzab1c2d3e4f5g6h7j8k9l/archive" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```
POST https://api.docinject.com/{org_slug}/inbox/{doc_id}/trigger-webhooks
```
...
```bash curl
curl -X POST "https://api.docinject.com/{org_slug}/inbox/doc_01hzab1c2d3e4f5g6h7j8k9l/trigger-webhooks" \
  -H "Authorization: Bearer YOUR_API_KEY" \
...
```
GET https://api.docinject.com/{org_slug}/inbox/{doc_id}/history
```
...
```bash curl
curl "https://api.docinject.com/{org_slug}/inbox/doc_01hzcd2d3e4f5g6h7j8k9l0m/history" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```
PATCH https://api.docinject.com/{org_slug}/inbox/{doc_id}/editor
```
...
```bash curl (assign)
curl -X PATCH "https://api.docinject.com/{org_slug}/inbox/doc_01hzab1c2d3e4f5g6h7j8k9l/editor" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
...
```
POST https://api.docinject.com/{org_slug}/inbox/{doc_id}/share-token
```
...
```bash curl
curl -X POST "https://api.docinject.com/{org_slug}/inbox/doc_01hzab1c2d3e4f5g6h7j8k9l/share-token" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```
GET https://api.docinject.com/{org_slug}/inbox/{doc_id}/share-token
```
...
```bash curl
curl "https://api.docinject.com/{org_slug}/inbox/doc_01hzab1c2d3e4f5g6h7j8k9l/share-token" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```
DELETE https://api.docinject.com/{org_slug}/inbox/{doc_id}/share-token
```
...
```bash curl
curl -X DELETE "https://api.docinject.com/{org_slug}/inbox/doc_01hzab1c2d3e4f5g6h7j8k9l/share-token" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
