...
```bash curl
curl "https://api.docinject.com/{org_slug}/inbox?filter=owned&limit=25" \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```javascript JavaScript
const res = await fetch(
  'https://api.docinject.com/{org_slug}/inbox?filter=owned&limit=25',
  {
    headers: {
...
```
GET https://api.docinject.com/{org_slug}/inbox/counts
```
...
```bash curl
curl "https://api.docinject.com/{org_slug}/inbox/counts" \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```javascript JavaScript
const res = await fetch('https://api.docinject.com/{org_slug}/inbox/counts', {
