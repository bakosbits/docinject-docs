...
<AccordionGroup>
  ...
  <Accordion title="Poll the inbox to sync documents to a CRM or knowledge base">
    If you can't use webhooks, describe a polling automation and the assistant will generate a scheduled recipe that calls `GET https://api.docinject/{org_slug}/inbox` with your API key and upserts the results into your target system.
  </Accordion>
</AccordionGroup>
