...
Go to **Profile → API Keys**, find the key you want to remove, and click **Delete**. Deletion takes effect immediately. Any requests using that key will receive a `401 Unauthorized` response.
...
<Warning>
  A DocInject administrator can delete any API key assigned to your organization.
</Warning>
