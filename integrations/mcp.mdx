...
description: "Connect Claude, n8n, Gumloop, and other AI assistants to your DocInject document library using the Model Context Protocol (MCP)."
---
...
You or an administrator must first create an API key in **Profile → API Keys** before anyone on the team can connect. See [API keys](/integrations/api-keys) for instructions.
