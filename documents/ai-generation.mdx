...
| **Handbook** | Reference material and policies organized for ongoing consultation. Sections are topic-driven and written for repeated use. |

The type you select determines the instructions and output structure the AI uses. All four types use the same section → step hierarchy in the editor.
