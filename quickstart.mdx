...
<Step title="Share or deploy">
  ...
  **Pull via the REST API**
  ...
  Authenticate with an API key and call the documents API to retrieve documents programmatically. See the [API reference](/api/authentication) to get started.
</Step>
