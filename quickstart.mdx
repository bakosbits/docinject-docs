...
<Step title="Sign up">
  Go to [app.docinject.io/signup](https://app.docinject.io/signup) and create your account.
...
<Step title="Share or deploy">
  ...
  **Share via embed link**
  ...
  Open the document and generate a share token. This creates a public URL at `app.docinject.io/embed/{org_slug}/{token}` that anyone can view without a DocInject account. Copy the URL from the **Shareable links** section of your dashboard.
