...
description: "DocInject turns SOPs, playbooks, guides, and handbooks into deployable process context. Publish once, then route to any tool via webhooks, API, or embeddable links."
---

DocInject helps teams turn SOPs, playbooks, guides, and handbooks into structured, reusable process context. Instead of storing procedures in a wiki that nobody reads, you publish them once and deploy them, via webhooks, the REST API, or embeddable share links, into the tools your team uses every day.
